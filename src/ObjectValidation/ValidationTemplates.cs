...
namespace wan24.ObjectValidation
{
    ...
    public static class ValidationTemplates
    {
        ...
        /// </summary>
        public static readonly Dictionary<string, List<ValidationAttribute>> PropertyValidations = [];

        /// <summary>
        /// Item validation templates (key is the template name, value a list of validation attributes to apply)
        /// </summary>
        public static readonly Dictionary<string, List<IItemValidationAttribute>> ItemValidations = [];
    }
}
